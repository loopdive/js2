...
A hybrid strategy is needed that preserves full ECMAScript semantics while enabling
...
Positive: full ECMAScript semantics preserved; high performance in common cases;
...
erased); permanent incompatible subset/superset/dialect (breaks ECMAScript
compatibility — see ADR-002).
