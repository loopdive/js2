...
| **1555** | lodash Tier 2 stress test — memoize, flow, partial application | 50 | done | medium |
| **1559** | ECMAScript spec compliance audit: section-by-section review, gap issues, HTML report | 50 | done | high |
| **1583** | Update stale lodash-tier1 stress test — resolver fixed, clamp/add behavior changed | 47 | review | low |
