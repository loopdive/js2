...
| **1791** | node:path — typed host import + standalone TS-port fallback | Backlog | ready | high |
...
| **1810** | node:path — typed host import + standalone TS-port fallback | Backlog | ready | high |
| **1811** | node:url — URL / URLSearchParams as host constructors | Backlog | ready | high |
| **1812** | node:buffer + global Buffer — host class with from/concat/toString | Backlog | ready | high |
| **1813** | node:events / EventEmitter — host class + closure-callback contract | Backlog | ready | high |
| **1814** | node:http (+ https) — GET round-trip host import (axios unblocker) | Backlog | ready | high |
