...
**test262 conformance**: 32,165 / 43,106 (74.6 %)
...
| **ir-full-coverage**     | **Active — NORTH STAR** (elevated 2026-07-02) | ALL AST kinds through the IR front-end; backends fork below the IR; direct AST→Wasm front-end retired | backend-agnostic-ir (trait seam)                                                    | #2856 (body-shape, P1), #2857 (class-method residual, P1), #2858 (call-graph-closure, P1), #2859 (param-type, P1), #2855 (retire warning channel); July-2026 audit keystones: #2949 (dynamic IrType, XL P1), #2950 (IR-first default flip), #2951 (skip-set gens+class), #2952 (multi-exit CF), #2955 (string de-polymorph) |
