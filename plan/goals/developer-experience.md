...
| **1392** | infra: refresh:benchmarks hangs in browser runtime Playwright eval | 52 | done | high |
| **1520** | docs: architectural comparison — Static Hermes (native) vs js2wasm (WasmGC AOT) | 52 | in-progress | high |
