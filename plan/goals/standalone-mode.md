...
| **1326** | Async standalone: implement microtask queue + CPS scheduler in Wasm for Promise/async without JS host | 50 | review | low |
...
| **1560** | Number.prototype formatting in pure Wasm: integer toString(radix), then Ryu for floats (standalone) | 50 | ready | medium |
