...
This source checkpoint still requires integration with current upstream main
(latest observed aafae4c03c), followed by composition checks and normal push to
the existing PR5748 head. It is not merged or ready for guard removal. The A0
