...
| **C4 — RegExp flags as proto accessors** | `global/S15.10.7.2_A9`, `ignoreCase/S15.10.7.3_A9`, `multiline/S15.10.7.4_A9` (3) | **Landed 2026-08-25.** `regexp-proto-delete.ts` adds a demand-gated standalone arm that checks the RegExp brand and exactly these three keys, then removes the comma-padded token from the mutable `$memberCsv`. It leaves accessors unseeded, preserving the #2885 inline/materialized read split; the retired broad arm's method/descriptor regressions are out of scope. Upstream/main: 0/3; branch: 3/3. #2885 controls: 5/5; stable neighboring controls: 6/6. |
