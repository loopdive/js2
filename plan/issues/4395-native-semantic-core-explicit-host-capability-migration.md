...
# Intentional growth for the #4395 capability-migration slice (#4396-#4402):
# the native semantic core, explicit capability providers and the generated
# JS value adapter land across the object/proxy runtime, call dispatch and
# runtime.ts in one reviewed change-set. Retiring the implicit JS-host
# fallbacks (#4401) is what shrinks these again.
loc-budget-allow:
  - total
