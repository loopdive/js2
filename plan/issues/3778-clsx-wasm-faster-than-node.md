...
| lane                  |        median | standard deviation |
| --------------------- | ------------: | -----------------: |
| standalone Wasm       | 0.00065105 us |      0.00000079 us |
| equivalent Node batch | 0.00993880 us |      0.00002401 us |
| Wasm speedup          |    **15.27x** |                    |

The run used 13,233,370 operations per round. The resulting 20,340-byte module
