...
loc-budget-allow:
  # 2026-09-08: explicit shared Symbol owner/consumer option and early reservation.
  - src/index.ts
...
### Paused checkpoint, weekly limit, 2026-09-10

User requested handoff and PR checkpoint with 1% weekly usage remaining. Stop further optimization/build/benchmark work after publishing this checkpoint. Existing open compiler PR: https://github.com/loopdive/js2/pull/5784 ; runtime PR: https://github.com/loopdive/v8x/pull/2 . Do not create a duplicate PR for the same branch.

- Last verified full unchanged-Deno comparison: V8 8.0 ms, QuickJS 22.5 ms, js2wasm 54.4 ms. Goal **not achieved**, js2wasm remains 2.4x slower than QuickJS. AOT deployment has no interpreter/compiler. Payload 42.9 MiB; core 34.0 MiB. Runtime report `tools/deno/results/2026-09-10-own-key-heap.md` contains raw-evidence links.
- Published implementation baseline: compiler `8fd489a918dee3be51bb1e75d191f9815a830eb0` (heapsort), compiler handoff HEAD before this checkpoint `a8e22705cbb2df`; runtime `83f5554`. Compiler worktree `/private/tmp/js2-deno-main-sync-20260908`, runtime `/private/tmp/v8x-deno-followup-20260908`. Clean compiler pin `/private/tmp/js2-own-key-heap-pinned-20260910`; clean artifact checkout `/private/tmp/v8x-aot-artifact-20260909` at `a1a711f`.
- Preserved control: `/private/tmp/deno-profile.RCcI44/core-own-key-heap-copying-speed.cwasm`, SHA256 `24b22a1ee113e7737802630a91c1f075fcd96a4beaaa03652a363c195ac58356`; executable and shared libraries in `/private/tmp/deno-profile.RCcI44/comparison-own-key-heap`. Keep all earlier controls and worktrees.
- Latest diagnostic: exact native example exits successfully; primordial phase 21.676 ms in one instrumented run. Node inspector probe `.tmp/profile-primordials.mjs` in runtime worktree profiles the exact optimized Wasm with stub native imports, checking 120/120 fresh-instance phase transitions. Raw profile `.tmp/primordials.cpuprofile`. These are **diagnostics, not end-to-end Deno/Wasmtime measurements**.
- Unfinished short-concat hash-cache experiment was **removed before checkpoint**. Directly constructing `ctx.hashedStrTypeIdx` with four fields in `emitStrConcatHelpers` caused invalid Wasm: `__str_concat` struct.new needed eight arguments but got four. Focused `issue-4376-own-key-heap-order.test.ts` failed at WebAssembly validation, before its 45 cases. No candidate performance result exists. Source restored exactly to HEAD; investigate type-index relocation/finalization before retrying, do not assume a simple subtype constructor is safe at that emission phase.
- Next: resolve that emission/type-index hazard and add a focused regression for runtime-generated property keys, or obtain a Wasmtime guest profile to refine attribution first. Run baseline/candidate correctness, then clean pinned full build, wasm-opt, exact native replay, and paired quiet-process measurements. Never claim the Node profile proves a Wasmtime speedup. No active build/test process remains at this checkpoint.

2026-09-10 primordial diagnostic follow-up: unchanged native AOT replay still passes; first core phase is 21.676 ms in one nested diagnostic, not a new benchmark median. A separate Node inspector probe of the exact optimized core validates 120/120 fresh-instance phase transitions with stub native imports. Aggregated self samples point to string flattening (105), property hashing (79), dynamic get (81), and property definition (73); Node allocation/GC dominates the overall profile and must not be attributed to Wasmtime. This motivates testing cached hashes for short concatenated strings: literals and flattened ropes already have cache slots, but short concatenations allocate plain NativeString and repeatedly hash the same generated property names. Candidate must be checked for correctness and measured against the unchanged control before any Deno speedup claim. Diagnostic script/profile currently in runtime worktree `.tmp/profile-primordials.mjs` and `.tmp/primordials.cpuprofile`.
...
2026-09-10 next optimization investigation: module lexical fix is verified progress. Inspecting primordial Reflect.ownKeys/descriptor copying found the open-object enumeration helpers use selection sort, O(n squared), reparsing index-like keys during comparisons. Measuring a checksum-validated enumeration scaling probe before trying in-place heapsort with the existing comparator and filtering semantics. This is a hypothesis about the remaining Deno cost, not yet exclusive attribution; unchanged full Deno timing will decide usefulness.

2026-09-10 module lexical fix measured: compiler `e805e38c6be7f4fd3d79475627db5c3fb14e5d7d`, clean pin `/private/tmp/js2-module-lexical-pinned-20260910`; runtime builder `8a3afe0`, native implementation unchanged `5400404`. Full build45485, wasm-opt80633, optimized-core2/2, precompile74648(1/1), exact native replay all terminal/pass. Nine native fixture tests9739 pass. Final new tests5/5 vs baseline1/5, existing module tests7/7, routing29/31 on both versions (same two pre-existing failures). Comparable combined36-case counts baseline30/36 vs candidate34/36; initial larger512MiB worker run OOM is not passing AnnexB coverage. Same executable paired10/10:66.8->56.4ms,15.5% lower. Three-engine21/21:V88.1ms/QuickJS23.1ms/js2wasm56.2ms, still2.4x behindQuickJS, goal active. Payload44,964,280bytes42.9MiB, core35,667,720bytes34.0MiB; RSS41.0MiB,physical5.9MiB. Core SHA25656b10ae3f559cfc12f66ae2fcff0ec8bf8a0006d915226c41485c54e4bd0d0bb. Artifacts `/private/tmp/deno-profile.RCcI44/core-module-lexical{,-O3,-copying-speed}` and comparison-module-lexical bundle; controlcore-module-eval-copying-speed remains preserved. Runtime report/raw `tools/deno/results/2026-09-10-module-lexical-*`. Separate nested diagnostic still firstcore/primordials23.4ms, usage4.7ms; get188/2.8ms and define_data317/2.7ms inclusive, not medians/exclusive attribution. Next trace legitimate primordial/builtin property setup and remaining dispatch. No compiler/interpreter deployed, no Deno source change. All build/test/profile sessions terminal, none overlapped timing.

2026-09-10 module lexical lookup fix: exact bridge WAT revealed thousands of instructions for global dynamic-lexical sidecar checks around private module-variable reads. `shouldUseRuntimeEvalGlobalLexicalRead` now excludes checker-resolved non-ambient external-module declarations; direct-eval activation handling remains earlier, ambient/unresolved paths remain conservative. Three const/let/var collision tests fail on baseline (900 instead of 42) and pass with fix; five final tests cover those plus mutable aliased imports and positive ambient-sidecar lookup. Existing seven module-function tests pass; nine native bridge tests pass. Broader routing candidate29/31, baseline so far reproduces the same two direct-eval-pool failures (ambient Object fallback and provider-invoked AOT callable); final baseline run pending. Initial combined suite exhausted 512MiB worker heap, rerun uses one 2048MiB fork. Reduced standalone bridge probe refusal numeric roundtrips approximately2.3ms to0.4ms/1000, not a Deno result. Configured TS7 passes. Full clean artifact, wasm-opt, native replay and timing pending.

2026-09-10 next performance pass: prior arithmetic experiment is progress through measured rejection, not a speedup. Runtime branch clean at `8f1f3f4`, compiler clean at `585213f9ff4d56`. Inspecting exact generated bridge KeepValue/ValueAt functions in plain versus refusal-provider graphs to classify remaining overhead before another production change. Preserve module-eval AOT artifact and native bundle as control; no interpreter or Deno source changes planned.
...
Symbol compiler checkpoint f6b953743e16fc12d39ff27dbea99ba3c5be095d signed with hooks. Typecheck64247 passes. Gates10885 pass LOC/function/coercion/oracle; dead-export evidence remains OPEN despite command exit0, unchanged certification limitation. Initial full runtime91568 reports36pass/1fail: the failure expected a nested Symbol to be rejected, but it now transfers (Some(true)). Replaced ONLY the unsupported-value control with a native External; retained absence, rollback and repair/retry assertions, targeted31383 passes1/1. Final full37-case76560 currentlyLIVE. Runtime compiler pin and README updated to f6b9537, not committed yet; registry/description transfer changes still need full optimized Deno replay. No live optimizer or artifact builder yet.


Final selected runtime76560 TERMINAL exit0:37/37 pass,5 filtered,74.66s. Runtime signed checkpoint7e24a789390160925c7a5e8188fac237c2923138 contains Symbol bridge plus compiler pinf6b953743e16fc12d39ff27dbea99ba3c5be095d. Runtime tracked worktree clean; retained .tmp only. Compiler source clean, handover dirty. All processes terminal. No push/PR. Next create clean detached inputs at these two hashes (retain previous build.4UZS08), build full runtime-profile core/provider from unchanged Deno1d4e6c1, run wasm-opt with validation, precompile with release Wasmtime47.0.3, replay unchanged disable_ops and hello_world compiler-free. Require absence of Symbol conversion diagnostic before calling native error formatting fully fixed. Prior build.4UZS08 files are earlier Error-only checkpoint artifacts and lack new Symbol bridge exports.


### Latest main sync and independent Symbol registry reduction

Requested upstream main now resolves to 0f5f34db78010466ef1224a0c6846f2d34aee1a2, fetched explicitly from loopdive/js2. Before merging, linked-symbol-registry test92050 fails1/1 at the final same-key Symbol.for equality across independent compiled graphs; published-reference identity and distinct fresh-Symbol controls both pass. This is recorded as an explicit expected failure, not a completed Symbol registry implementation. Existing native/compiled single-realm tests do not establish cross-graph registry identity.

Clean Symbol artifact builder has finished and produced core.wasm7769284bytes SHA256d19d76dafdf288247173041363d3a158628a59071b367cc7ff6f81b536707d5d and provider.wasm25463298bytes SHA25691f15540a56afae8b92fe909603fb3df27bf17320049d96a6fbf2bd8221a6ab1 under /private/tmp/deno-symbol-build.1iySPT. Original terminal status could not be recovered after session rollover; build.log ends with artifact/provenance records, no live builder process. Optimization and native replay remain unverified. Preserve these inputs at their recorded revisions rather than mislabelling them as post-sync artifacts.


### Latest upstream merge and optimized Symbol artifacts

Signed merge465c7ba865691be7ee0bb3fc71d6a9151c9eba15 incorporates fetched loopdive/js2 main0f5f34db78010466ef1224a0c6846f2d34aee1a2, verified by ancestry and embedded SSH signature. No conflicts. Checkpoint99c158f7ee5432 preserves the pre-merge handover and known registry failure. Primary user checkout is untouched. Post-merge TypeScript7 check passes; final five-suite70110 reports52/52:50 ordinary passing tests plus2 explicitly expected failures (shadowed globalThis and independent Symbol registry identity). Registry setup now runs in beforeAll, with published-identity and distinct-fresh-symbol tests separate, so compile/link/setup failures cannot satisfy the expected failure. Targeted37252 passes3/3 (2 ordinary,1 expected). No broad test262 or Deno suite claim.

Gates93004 pass LOC/function against the exact fetched main base, coercion and oracle. Dead-export command exits0 but still says graph OPEN / strict modeled closure FAIL due unresolved dynamic imports; retirement remains uncertified. Source merge review preserves the Error/Symbol finalization hooks while adding upstream standalone peer terminals.

Clean artifact inputs remain compilerf6b9537/runtime7e24a78, BEFORE the latest merge, and are not relabelled as merge465c artifacts. Optimizer37791 TERMINAL exit0 using bundled Binaryen125: core-O3.wasm5516516bytes SHA256c13af42cdc5c6b5a9bba1a8de588afe893acaab13e0a954d7ab02933c72ee59a; provider-O3.wasm15833768bytes SHA256e79dbc76cad17defb9d7b0f0daf4e62a917f16814c5e1bf0f39fec260bee6289. Both require optimized=true and WebAssembly.validate. Node liftoff-only canaries/link check30e3ed TERMINAL exit0: all five canaries plus deferred core initialization pass. Wasmtime core precompile69390 passes1/1 in36.00s; provider2932 passes1/1 in133.04s.

Native compiler-free replay78644(disable_ops) and49774(hello_world) currently LIVE with logs in /private/tmp/deno-symbol-build.1iySPT. Deno libs/core diff remains empty, and its dependency features exclude js2wasm_runtime_compile. Wait for terminal status and inspect exact stdout/stderr before claiming the Symbol diagnostic repaired.

Independent graph registry follow-up: symbol-native.ts allocates registry arrays, description storage, ID counter and boxed-value intern table per module. A fix must coordinate all identity-bearing state, not merely compare registry strings or forward a lookup while reboxing locally. Preserve fresh uniqueness, registered equality, typed/untyped coercion, keyFor/description and Symbol-key lookup across graphs. The newly merged standalone-link-boundary.ts routes foreign object reads to one npm provider; it does not provide shared Symbol ownership. Full integration goal remains active; no push/PR in this continuation.


Native Symbol replay complete: hello49774 TERMINAL exit0; disable_ops78644 TERMINAL exit101 at the unchanged example unwrap, as intended. Independent assertions67f35e pass: hello stdout exactly matches sum6 plus the deliberately caught serde_v8 TypeError, stderr has exactly11 normal host callbacks; disable stdout is empty and its JsError reports Uncaught Error: op is disabled with additional_properties: []. Neither replay has the former Symbol host-conversion diagnostic or internal error.rs:1294 panic. This verifies the native Symbol bridge against unchanged deno_core using optimized/precompiled f6b9537 artifacts and runtime7e24a78, not a full native rebuild of merge465c.

All artifact/test/native sessions in this continuation are terminal. Runtime tracked tree remains clean except retained untracked .tmp; Deno libs/core remains unchanged. Compiler follow-up refines the expected-failure test so setup failures cannot pass, and records this handover. Remaining work includes cross-graph Symbol state, new-artifact rebuilds after the upstream merge, op2 graph packages rebuilt for the current structural ABI, wider unchanged Deno tests and compiler-free distribution. No full integration completion or broad conformance certification is claimed.


### Implementation Plan: shared Symbol globals

Use an explicit standaloneSymbolState option: export for the context owner, or a linked provider module for consumers. Share all six mutable Wasm globals: counter, description table, registry keys/IDs/count, and canonical boxed-value intern table. Reserve all six global imports before helper code generation; fill their structural types when native Symbol types are registered. Preserve default standalone behavior. Force owner state initialization in both compiler entry paths so a context without local Symbol use still exports the ABI. Native context linking must admit only the six named globals, validate export kinds, and bind real context exports before deferred trap defaults. Verify registry equality, fresh uniqueness, descriptions/keyFor, typed-erased transfers, property keys, growth and separate-owner isolation. The existing failing test is the baseline. This is an ABI addition requiring context/graph artifacts to be rebuilt together.


Shared-state candidate evidence: late-import candidate10581 fails to validate __closure_bag_ensure because existing late-global index repair misses a cached index. Replaced it with early reservation before any defined functions/globals, with a loud ordering assertion; generic global-index repair was not changed. Original regression14401 passes3/3. Expanded11218 reports10pass/4fail because the JS harness passed an opaque reference directly to an exported i32 Symbol parameter. Corrected wrapper routes any to a typed helper inside Wasm, preserving the intended coercion test;45407 passes14/14 across compile and compileMulti, including foreign Symbol property keys, description/keyFor, absent/empty, boxed identity and table growth.

Broader55919 passes86/86 in7 suites, including one existing expected shadowed-globalThis failure. Its requested Symbol-valued-field path was misspelled, so that suite was not selected; correct filename is running separately9916. Native71175 fails at link time on missing v8__Value__BooleanValue newly referenced by the test, not shared globals. General BooleanValue remains an ABI gap; exact Boolean controls now use existing is_true rather than ToBoolean coercion. Native6458 is the candidate replay in progress, with fresh context/producer/replacement fixtures under runtime .tmp/linked-shared-symbols. Artifact builder runtime profile exports Symbol state and commits the actual option into provenance; frozen POC profile is unchanged. No full core rebuild yet.


Native shared-state replay6458 TERMINAL exit0,1/1: registered and fresh Symbol comparisons, cross-graph registry/description reads, native Symbol::for_key identity, and retained callbacks all pass. Full selected runtime67068 passes37/37 with5 artifact-specific cases filtered. Corrected Symbol-valued-field suite9916 passes12/12; combined with55919 this is98 total cases,97 ordinary plus one existing expected shadowed-globalThis failure, not a broad test262 result. Typecheck50040 passes and compiler gates28269 pass LOC/function/coercion/oracle; dead-export graph remains OPEN as before. Additional old-context negative fixture and test are in progress. Runtime-eval provider Symbol ownership and multiple Deno Contexts within one isolate still require explicit coverage, separate from linked graphs sharing one context.


Final shared-state native53926 TERMINAL exit0:38/38,5 artifact-specific filters. New missing-owner-export test48492 passes1/1 and verifies producerRegistered remains undefined after refusal; compiler-free cargo check exits0. Fixture root .tmp/linked-shared-symbols-v2 contains owner, unshared-owner negative control, producer and replacement. The provider AOT used by these tests is the prior f6b9537 artifact and only supplies interpreter infrastructure; it does not prove the new provider export option. Runtime builder now exports Symbol state from both core and fallback interpreter for its runtime profile and records provider options as a digested generated input. Its syntax check passes, but full clean core/provider regeneration and native example replay remain next. Frozen POC options are unchanged. Runtime-eval Symbol dispatch and multiple Contexts per isolate remain separately unverified. General v8__Value__BooleanValue is still missing and tracked here as an ABI follow-up.


Shared Symbol checkpoints: compiler5b0751634ded1316b9a3baa7c77507e4fec13400 and runtime2ddeebec4423f4ecaa68cae3eca09e1c5bb919d4, both signed. Compiler tracked source clean before this handover addition; runtime tracked tree clean with retained .tmp only. No push or PR. Fresh clean detached inputs under /private/tmp/deno-shared-symbol-build.zBQ1pr/{js2,v8x}; reuse verified clean detached Deno /private/tmp/deno-error-prototype-build.4UZS08/deno at1d4e6c1. Native unchanged hello_world, disable_ops and op2 rebuild17395 TERMINAL exit0, compiler feature absent and libs/core diff empty. They have NOT yet run against new shared-state artifacts.

Full runtime-profile raw artifact build36867 currently LIVE, logs /private/tmp/deno-shared-symbol-build.zBQ1pr/build.log. Core compilation reached normal v8x:deno host import warnings, supplied by native host; no failure observed. Wait the same handle, then require terminal success, optimize both outputs with wasm-opt and validation, run provider canaries with --liftoff-only, precompile with Wasmtime, and replay native examples. op2 additionally needs freshly compiled graph packages from the updated sidecar. Old f6b9537 artifacts do not export shared globals and must not be used to claim new-ABI graph compatibility.


Raw shared-state build36867 TERMINAL exit0. Core7764516bytes SHA256ad7d2561576f74465d4703f56eee42b497bdf08f8755092390f3eef62b9921fe; provider25464824bytes SHA256b46a7e512be0bf5c18fdd0a25e3a82c2c8f7eb20e169ca6823a2ed420c5331a9. Independent checkd5ee9d exits0: BOTH raw modules export all six Symbol globals, provider still has zero imports, and provenance records standaloneSymbolState=export for both actual compile option sets. Builder succeeded including raw provider canaries and core/provider linking.

Optimizer39154 currently LIVE under clean compiler in build.zBQ1pr, processing core/provider sequentially through optimizeBinaryAsync(level3,preserveNamestrue); requires optimized=true and WebAssembly.validate before writing each -O3.wasm. Wait same handle. Then validate optimized canaries/linking, precompile both via release Wasmtime47.0.3 and replay newly rebuilt native examples. These exact shared-state native artifacts have not yet been executed. Full integration remains active.


### Implementation Plan: native Boolean conversion ABI

Implement v8__Value__BooleanValue and v8__Value__ToBoolean using native primitive tags. False: undefined/null, false, positive/negative zero, NaN, zero BigInt and empty string. Symbols and object-like Values remain true without property access or user coercion. ToBoolean returns a real native Boolean allocated in the supplied isolate. Internal Data-only variants are not valid JavaScript Value inputs. Add a compiler-free 22-value matrix through both public APIs; first capture the baseline link failure. This does not alter compiled-module ABI or the running shared-state artifact build.


### Shared-state native replay complete

Compiler5b0751634ded1316b9a3baa7c77507e4fec13400/runtime2ddeebec4423f4ecaa68cae3eca09e1c5bb919d4 clean builds at /private/tmp/deno-shared-symbol-build.zBQ1pr are optimized and precompiled. Optimizer39154 exits0: core-O3.wasm5516654bytes SHA256263397cb947f9b83ab5f7cf0d244c11bdd328ca1e9e33521346ffe9f9b657938; provider-O3.wasm15825492bytes SHA256435d415d9f1d282d3995018449437fafb43c085550306287427d5e5a032d8024. Wasmtime precompile71450(core) and28558(provider) each pass1/1; independent liftoff-only canary/link/global-export assertions d9fa0c exit0.

Exact unchanged op2 sources were compiled with production compile-graph.ts at optimization3 and precompiled into source-bound packages under op2-graphs. Source hashes0c2285071a4236882d9ee2bfa38974d48f5b934c219607a7d3c1cb6d0b915fb6(extension) and416ac18711e03c871b91d7aca7dcb1d5109fa480a459adc4f7b8bdb828754555(application) independently match the native binding algorithm. Both packages import shared context state.

Native sessions19966(hello_world) and3647(op2) TERMINAL exit0;38328(disable_ops) TERMINAL exit101 at its intended example unwrap. Output assertions ed852b pass: exact hello sum6 and deliberately caught serde_v8 TypeError,11 normal callbacks; op2 empty stdout and4 normal callbacks including op_use_state; disable_ops has op-disabled JsError, empty additional_properties and example28:6 panic. No host-conversion diagnostic or internal error.rs:1294 panic. Deno sources unchanged, runtime compilation disabled. These are three example checks, not full Deno conformance.

Boolean ABI baseline48147 fails linking both v8__Value__BooleanValue and v8__Value__ToBoolean. Candidate native implementation uses primitive tags, preserves object truthiness without conversion hooks, and allocates real Boolean values. Compiler-free targeted61677 passes1/1 with22 values through both APIs. Selected39-test native regression51578 currently running against the fresh precompiled provider. Runtime production changes are not yet committed at this checkpoint. Full integration remains incomplete; runtime-eval Symbol ownership, multiple Contexts, broader module semantics and host coverage remain.


Boolean follow-up complete locally: selected regression51578 TERMINAL exit0,39/39 pass,5 explicitly filtered artifact-specific tests,77.88s. Compiler-free cargo check6ed487 exits0. Signed runtime checkpoint1398c3a implements both APIs and the22-value regression; prior baseline48147 had both missing linker symbols. No production Deno sources changed. No push or PR in this continuation. All native example and regression sessions are terminal. Next substantive work is explicit runtime-eval Symbol ownership and multiple-Context isolation coverage before broader unchanged Deno tests and packaging.


### Implementation Plan: multiple native Contexts

Add a two-Context regression in one isolate using independently instantiated owner/producer fixtures. Check registered Symbol identity is shared through the native isolate registry, fresh Symbols from distinct Wasmtime stores do not alias, both callbacks begin at42 after adding2, replacement in one context leaves the other callback unchanged, and both retained callbacks independently advance to45. This distinguishes context-local execution state from isolate-wide Symbol.for identity. Runtime baseline1398c3a, targeted candidate33573 running. No changes to Deno test sources.


Multiple-context candidate33573 TERMINAL exit0,1/1. Both contexts preserve independent callback state and replacement, registered Symbols alias through the isolate registry, fresh Symbols do not. Added a separate dynamic-eval fixture accepting native-supplied source after compilation. Probe arithmetic first, then Symbol.for identity, keyFor, description and fresh distinctness against compiled context values. No expected-failure marker: unexpected eval throw or false result is failure. Fixture build initially failed due omitted tsx loader (ac8f8d); corrected loader build21299 is running. This is a native Wasmtime regression, not yet unchanged deno_core suite coverage.


Dynamic-eval baseline9367 fails converting the published value to Function, before any eval assertion. Marker61896 passes initialization42 but still fails function conversion. Brand46660 proves producer typeof=function while native context sees object=true/undefined=false. Candidate registers canonical runtime-eval callable carrier types at the existing late-registration stage for standalone host bridges, even without local eval syntax. It does not enable the runtime-eval boundary plan or add an interpreter import. Needed for receiving foreign callable values; classification alone is insufficient, so the same native test must also invoke it and verify dynamic results.


Carrier candidate87487 passes marker and both producer/consumer callable brands, but invocation throws before arithmetic. Diagnostic52261 captures __runtime_eval_unwrap_call_result -> __apply_closure -> __v8x_value_call, thrown Wasm exception undefined. Refined control82806 adds a native-supplied __call_control__ source returning true without eval; it PASSES through the same callable. Actual eval source40+2===42 returns caught: undefined from a catch inside the producing module. This localizes remaining failure to eval execution, not missing initialization, branding or basic argument/return transfer. Symbol assertions have NOT been reached. Fixture roots linked-symbol-eval-{marker,brand,carrier,control} retained under runtime .tmp. Compiler candidate only changes the existing late carrier-registration condition to include standalone emitHostBridge owners; TypeScript check29501 exits0. Focused linked Symbol suite90916 result recorded next.

Runtime HEAD remains1398c3a with uncommitted tests and fixture-builder edits. Compiler HEAD remains5b075 with uncommitted carrier-registration candidate and handover. Do not call the candidate fully fixed or rebuild production artifacts until eval regression and broader guards pass. Next inspect linked context intrinsic eval resolution/initialization and provider error transport; global Symbol ownership remains unproven for runtime eval. Multiple-context native test33573 was independently green on baseline1398c3a. No push/PR; full integration active.


Compiler linked Symbol90916 did NOT execute tests: both setup compilations fail because Vitest workers did not inherit --experimental-wasm-exnref;14 skipped, not passes or attributed compiler regressions. Corrected22852 explicitly passes --poolOptions.forks.execArgv=--experimental-wasm-exnref and remains LIVE. Resume this exact handle, do not restart on empty output. All native diagnostic sessions are terminal.


### Eval result envelope investigation

Previous goal turn made source/test progress. Malformed live worker22852 was diagnosed by ps: node received individual characters (- - e x p...) from string-valued Vitest execArgv and waits on stdin, not executing tests. Do not treat it as a test failure or kill unrelated processes. Corrected explicit .tmp/vitest-deno-carrier.config.ts uses array execArgv with liftoff-only/exnref;53594 TERMINAL exit0,14/14 linked Symbol tests.

Independent Node probe .tmp/probe-eval-envelope.mjs calls optimized provider __runtime_indirect_eval directly. Baseline7086/10991/49240: result length2 but Array.isArray=false and both indexed fields undefined, even after explicitly creating a local any[] positive-control type. Provider has no __module_init export, so not missing deferred initialization. Candidate keeps standalone externref vector ABI root non-final at finalizeLeafStructTypes, independent of local subtype demand. Probe96481 now sees array=true,length2,field0=true,field1=canonical wrapped value. Same provider artifact unchanged, only consumer regenerated. Native full eval56931 running with regenerated linked-symbol-eval-openvec fixtures. This is evidence for a shared-vector finality mismatch, not yet full eval/Symbol completion.


Native eval56931 now reaches Symbol checks: call control, arithmetic, Symbol.for('linked-key') equality and Symbol.keyFor all pass. First failure is producerFresh.description === 'fresh' returning false, consistent with provider-local Symbol description tables differing from core-owned ones. Next architecture: zero-import interpreter owns the six Symbol globals; core imports and re-exports those exact globals; graphs continue importing from core. Requires explicit compiler import+re-export option, allowlisted runtime provider global imports, builder provenance/pins and fixtures rebuilt together. Avoid copying global values between instances: table growth and counters require the same mutable Global identities. Full Deno bootstrap must be replayed after this ABI change.

Added compiler linked-vector test through both entry paths. Candidate43145 reports14 linked Symbol passes/2 vector failures: vector branding, length and numeric read now pass, but first Boolean element strict-equality fails. This is additional evidence, not a green suite. Added producer-local ownFirst control;81373 running to distinguish local literal branding from cross-module primitive transfer. Original compiler typecheck in43145 shell exits0 after tests, so do not use overall shell exit0 as a test pass. Both compiler changes remain uncommitted candidates.


Array-test follow-up:81373 proves producer-local first-element equality failure. Splitting mixed-vector and Boolean tests89573 gives4fail; string/number mixed vector40065 also fails the producer-local equality, so do NOT attribute this only to Boolean branding. Explicit __module_init added in both builders;86633 remains4fail. Current test file has4 ordinary failing cases, not expected-failure markers. It is not a completed regression gate and needs diagnosis (local first-element read/equality vs literal representation). Independent provider-envelope probe96481 remains valid and does call initialization. Native eval56931 still proves arithmetic/registry/keyFor pass and description fails under the vector candidate.

End-of-turn state: compiler index.ts contains two uncommitted candidates (late standalone host callable registration and open externref-vector ABI root), new tests/issue-4376-linked-vector-finality.test.ts untracked, issue modified. Runtime tests and linked fixture builder remain uncommitted. Corrected compiler53594 passed14/14 before vector candidate; subsequent new vector test status is as above. No native/test computation remains live except malformed worker22852 waiting on stdin with character-split CLI options; do not restart or kill it casually. No artifacts repinned or production core rebuilt for the new candidate. Continue with shared interpreter/core Symbol ownership and local-array regression diagnosis; full integration active.


### Implementation Plan: interpreter-owned shared Symbol state

Extend standaloneSymbolState import configuration with optional reexport:true. Core imports the six exact mutable globals from zero-import interpreter and re-exports them for linked graphs; no copied counters or stale table references. Runtime allowlists these provider globals by name and Global type, retaining one interpreter per context store. Build profile must record new core import/re-export options. First validate using compact native fixtures with the existing zero-import provider, then test canonical global identity and growth at compiler level. Full artifact rebuild follows only after guards pass.


Interpreter-owned Symbol candidate85496 TERMINAL exit0, native eval1/1. Same unchanged optimized provider; context imports and re-exports its globals, producer/eval/replacement import context globals. All controls and dynamic arithmetic, registered identity/keyFor, fresh description and fresh distinctness pass. Runtime prepare_module now permits only the six named Global imports from runtime-eval namespace and retains function-name checks for Func imports. Runtime profile builder updated to import+reexport from provider; frozen POC options untouched. Full selected native regression launched next (41 expected cases). No production core rebuild yet.


Native full regression42478 TERMINAL exit0,41/41 pass,5 explicitly filtered artifact-specific cases,95.30s. Includes runtime_eval_preserves_context_symbol_identity and separate_contexts_isolate_graph_state_but_share_native_symbol_registry. Compiler re-export96731 passes2/2 across compile/compileMulti, proving relay exports are the exact WebAssembly.Global objects and registry/fresh descriptions remain shared; following TypeScript7 check exits0. Runtime builder syntax check passes; core runtime-profile options import+reexport provider Symbol state, frozen POC unchanged. Still no clean production artifact rebuild or new native Deno example replay.

Independent baseline probe94437 imports clean5b075 and candidate compilers: both report {first:0,kind:1,raw:1} for [true,42] read through any. Thus the first element is Boolean and numerically converts to1; the defect is equality lowering, not missing array contents, and predates this candidate. Mixed-vector transport regression now checks first string charCodeAt(0)=109 rather than this unrelated equality operator; separate Boolean strict-equality cases remain ordinary failing tests, not suppressed. Focused transport62922 result follows. Need diagnose/track the equality defect before treating this whole new test file as green.


Focused vector transport62922 TERMINAL exit0:2/2 pass (single/multi),2 equality cases intentionally unselected by name filter, not counted as passing. All actual native regression and fixture-build sessions terminal. Compiler and runtime changes remain uncommitted pending compiler gates and resolution/accounting of the pre-existing equality regressions. Preserve malformed worker22852 (stdin wait, not test execution), all .tmp fixtures, and the primary dirty checkout. Next: local any-element equality diagnosis, compiler regression/gates, signed checkpoints and pins, clean optimized/precompiled core/provider rebuild, then unchanged Deno hello_world/disable_ops/op2 replay with compiler disabled. Full integration goal active.


### Implementation Plan: dynamic read property keys

Baseline WAT170320 shows failing equality's v[0] uses IR __dyn_member_get with boxed numeric0; successful typeof/numeric controls use indexed-array getter. Native __dyn_member_get passed this raw boxed key directly to __extern_get, unlike __dyn_member_set which already canonicalizes ToPropertyKey. Add conversion in both getter carrier modes only for native standalone/WASI, after RequireObjectCoercible and key carrier unboxing, before named-property dispatch. Host readers retain host-owned conversion. Missing native converter must fail loudly. Preserve evaluation order and Symbol keys, test numeric/string/object keys and null receivers as well as the original equality regression.


Dynamic getter fix28185 passes4/4 original vector/equality cases;59968 passes2/2 numeric/string/object/Symbol key controls with one-time coercion and null-receiver ordering. Broad90720 reports92pass/3fail across95cases. Clean baseline1794 reproduces2fail (host selfhost string helper and obsolete arithmetic selector refusal), but not nonfast WASI __any_to_index import refusal. Narrowed the fix to standalone, the Deno target in scope, preserving existing WASI lowering and recording its separate native-key dependency gap rather than adding an unapproved host import. Extracted standaloneMemberReadKeyConversion to keep ensureDynMemberGet below300LOC; initial function gate22917 failed at307lines before extraction. Rerun gates/tests before checkpoint.


Getter candidate narrowed to standalone36659:24pass/1fail, remaining arithmetic-selector refusal exactly matches clean baseline. New equality and key-coercion tests pass; WASI valid-Wasm test restored. Gates14713 pass coercion/oracle/function; exact-main0f5 LOC/function gates64977 pass and TypeScript7 exits0. Function extracted rather than budget-grant expansion. Reachability84698 exits0 but explicitly graph OPEN / strict modeled closure FAIL from unresolved dynamic imports; preservation-only6/6 passes, retirement NOT certified. Final combined nine-suite52340 pending terminal result at this checkpoint.


Final combined52340 TERMINAL exit1:95pass/2fail across97cases in9suites. Both failures exactly reproduced on clean5b075 baseline1794 (host native-string selfhost setup and outdated arithmetic-selector refusal). All22 Deno-focused cases pass, including original Boolean equality, reference-vector layout, exact Symbol-global reexports and key-coercion ordering. No newly failing check remains in this selected set. This is not broad test262 conformance. Compiler candidate ready for local signed checkpoint; production clean artifacts still need rebuild and native examples replay.


### Signed checkpoints and clean production rebuild

Compiler5086736c37bd96f34e6dd69fdee4ac1fad18dfcf signed with hooks; runtime4f07fbba9e2103233af3a64d1e37e9845eee58af signed. Compiler tracked tree was clean after commit; runtime compiler pins updated everywhere. Native eval48950 passes1/1 using exact5086736 fixtures at .tmp/linked-provider-final. Runtime selected41/41 evidence precedes getter fix; final exact-compiler eval passes. No push or PR.

Builder correction is in runtime4f07: runtime core now has typed global imports, so raw initialization can no longer use only function stubs. Preserve isolated-child validation using length-prefixed app/provider bytes, actual provider globals, and liftoff-only; frozen POC remains function-stub checked. In-process real-provider linking accepts correctly typed Global exports and still checks initial script phase/probe. Syntax and whitespace checks pass; full build is its execution validation.

Clean detached inputs at /private/tmp/deno-interpreter-owner-build.eoE5Jn/{js2,v8x}, compiler5086736/runtime4f07; compiler node_modules symlink to /private/tmp/js2-poc-fixed2/node_modules. Reuse clean Deno /private/tmp/deno-error-prototype-build.4UZS08/deno at1d4e6c1. Full runtime-profile artifact build3446 currently LIVE, log /private/tmp/deno-interpreter-owner-build.eoE5Jn/build.log. Latest log shows normal native v8x:deno host import warnings; no failure. Outputs core.wasm/provider.wasm/provenance.json under that root. Wait exact handle; then optimize with bundled wasm-opt, validate/link/canaries with liftoff-only, precompile using Wasmtime, rebuild exact op2 graph packages and replay unchanged examples.

Deno example rebuild30558 also LIVE in /private/tmp/deno-realm-run-20260908: cargo build --offline --release -j2 -p deno_core --example hello_world --example disable_ops --example op2 --target-dir /private/tmp/v8x-deno-followup-20260908/target. Cargo is recompiling dependencies; not a failure. Its v8x dependency excludes runtime compilation and libs/core diff is empty. Preserve outputs and wait rather than restarting. Full integration remains active.


Clean build3446 TERMINAL exit0, including isolated raw bootstrap with real provider globals. New core7764742bytes SHA2568b1cefd9f57525ace18dcfa733aaf008d3505b8063e6350468abdcc3cdd81578. Provider25464824bytes SHA256b46a7e512be0bf5c18fdd0a25e3a82c2c8f7eb20e169ca6823a2ed420c5331a9, byte-identical to prior provider. Native Deno example rebuild30558 TERMINAL exit0,2m11s. Optimizer59034 currently LIVE, .tmp/optimize-owner-artifacts.mjs, producing core/provider-O3.wasm with optimized=true+validation checks.

Exact-source op2 graph rebuild68545 TERMINAL exit0 at optimization3; extension60223bytes SHA2562763e681b7a50238f469ddf327717cd49cc74bc83095956761ea2f484b5e5d03; application62007bytes SHA2566276d0381caf582aebdf773c54d41de1441aabbe50cf91b8775b705b63801f2f. Both precompiled by generic raw-module Wasmtime helper688d34,1/1each; bindings finalized. Native hashes extension76e1ac84324cf79d1aa81361472ce274bce0acd6e33898033d29bd178835f6c7 and applicationc041c401ed911bcf081c631e9cb3824a21d34c6150d2b2e4e2acbb5070d913d4. Root /private/tmp/deno-interpreter-owner-build.eoE5Jn/op2-graphs. No example replay against new core yet.


Optimizer59034 emitted validated core-O3.wasm5681364bytes SHA25658b588b369301cba276f843ed320fef6d7108a73676f77dc30a399a7b330a72e; provider optimization still LIVE in same process. Core Wasmtime precompile28436 LIVE. Independent optimized validation script .tmp/validate-owner-artifacts.mjs ready:5 canaries, deferred core phase/probe0,6 exact Global identities, zero provider imports. Run only after provider optimization finishes.

Additional unchanged deno_core unit-test build56352 LIVE: cargo test --offline --release -j2 -p deno_core --lib --no-run --target-dir /private/tmp/v8x-deno-followup-20260908/target. This is build-only, not test evidence. Candidate next tests runtime::tests::misc::test_execute_script_return_value (numeric3/stringfoobar) and runtime::tests::ops::test_op_disabled (expected op-disabled exception). Read exact test list after binary links; avoid guessing test names or claiming coverage from a successful compile.


### September 9: optimized bootstrap control and unchanged Deno replay

New core-O3.wasm (58b588b3, 5681364 bytes) fails phase3 with stack exhaustion on both unchanged Deno unit tests. New raw core precompiled successfully (57536,1/1) and booted in the same binary, reaching diagnostic unresolved v8__Value__IntegerValue (58594,exit134), as did the old artifact pair (95978). Explicit bundled Binaryen125 invocation: --no-inline BEFORE -O3, --pass-arg=no-inline@__new_*, --all-features --disable-custom-descriptors -g. Result core-cli-O3.wasm5520428bytes SHA256fc7e6d5b6f4214607937b4202fde00b92620b436bb07301e4ece20994009c55b. Precompile97848 passed1/1 in27.00s. This core boots: unchanged hello_world50961 exit0 with expected caught serde TypeError; unchanged op2 example89765 exit0, four normal callbacks including op_use_state, using newly rebuilt exact-source graph packages. Unchanged runtime::tests::ops::test_op_disabled8431 passed1/1,428filtered. Unchanged script-return60117 reaches missing IntegerValue after bootstrap,exit134. No Deno source/test changes.

Successful runs above use prior optimized provider /private/tmp/deno-shared-symbol-build.zBQ1pr/provider-O3.cwasm. Its raw bytes exactly match fresh raw provider. Fresh automatically optimized provider passed5canaries and six exact Global identities (ca8365), but differs from prior optimized bytes. Explicit CLI reoptimization of fresh provider remains LIVE session11022, output /private/tmp/deno-interpreter-owner-build.eoE5Jn/provider-cli-O3.wasm. Do not claim completion/precompile yet. Automatic optimizer was invoked from runtime worktree, where package resolution differs; in-process fallback ignores inline hints. Explicit CLI avoids ambiguity. Exact pass/root-cause attribution needs confirmation; this is not evidence Binaryen generally miscompiles. Preserve all artifacts. Next verify fresh CLI provider/hash, precompile if different, then implement IntegerValue with boundary/exception tests. Full integration incomplete; no push/PR.


### Implementation Plan: V8 IntegerValue conversion

Follow V8 api.cc Value::IntegerValue and conversions-inl.h NumberToInt64 (primary source read September9): ToNumber/ToInteger for non-numbers, then truncation toward zero, NaN0, saturation at signed64limits including infinities. Stage numeric and simple primitive cases first to unblock unchanged test_execute_script_return_value; retain loud failure for string/object coercion until a realm conversion entry point handles full ToPrimitive and exception propagation. Do not count scalar coverage as full conversion conformance. Candidate runtime src/js2wasm/mod.rs now implements Number/Boolean/null/undefined and TypeError for Symbol/BigInt. Test89833 passed1/1 with12numeric boundary inputs+4primitive inputs. Symbol/BigInt exception regression24471 waits on active Deno build12086; not yet test evidence. No commit yet. Deno build12086 uses no runtime compiler, unchanged core tests. After completion run exact script-return and disabled-op against core-cli-O3.cwasm plus previous provider-O3.cwasm.

Fresh explicit provider optimizer11022 TERMINAL exit0. Output provider-cli-O3.wasm15825492bytes SHA256435d415d9f1d282d3995018449437fafb43c085550306287427d5e5a032d8024, byte-identical to old optimized provider. Existing precompiled provider corresponds to these exact bytes; no unnecessary recompile needed. All three artifacts now have matching optimized raw-byte evidence. Full integration and nonnumeric IntegerValue coercion remain active work.


Integer candidate validation complete: Deno build12086 terminal0,1m05s, compiler-free features. Native IntegerValue tests24471 terminal0,2/2 (12 numeric boundaries,4 simple primitives,2 caught TypeError controls). Unchanged Deno script-return78483 terminal0,1/1 in10.83s,428filtered: both numeric3 and stringfoobar assertions pass. Unchanged disabled-op1576 terminal0,1/1 in10.29s,428filtered. These are two selected cases, not all429 tests. Runtime diff-check exits0. Candidate source/tests still uncommitted and general string/object IntegerValue coercion still unfinished. All meaningful sessions terminal; retain malformed idle worker22852. Next finish conversion through an actual realm ToNumber/ToPrimitive bridge (not Number() on BigInt and not native fake strings), add nonnumeric ordering/exception cases, rerun compact/full selected native regressions and unchanged Deno tests, then checkpoint/pin and artifact-rebuild if bridge exports change.


### Numeric coercion bridge candidate and remaining exception failure

Previous goal turn made progress: unchanged Deno script-return became passing. Current continuation adds __v8x_value_to_number to context-value-bridge.mjs and export inventory. It performs unary plus (not Number, because BigInt must throw), returning a retained [true,number] or [false,originalException] envelope. realm_objects::to_number uses bound value/context owner and existing callback-access guard, decodes envelope, records original realm exception; IntegerValue now delegates nonnumeric inputs there. Rust compiler-free cargo check61778 passes. New bridge has not been rebuilt into full production core or validated through native coercion tests. All changes remain uncommitted.

Extended ordinary tools/js2wasm/test-context-value-bridge.mjs with five strings (empty, decimal, hex, binary, NaN), Symbol.toPrimitive requiring number hint and returning42.9, and valueOf throwing a shared token object. Sessions62150/87235/11677/15251 terminal1: all five strings and object42.9 pass, thrown-token case raises WebAssembly.Exception from __v8x_value_to_number before envelope decoding. Input handle135 is valid kind5; successful envelopes are kind9 withBoolean kind2. Existing buffer/identity assertions pass, but full script remains failing. Temporary console diagnostics remain. Script writes .tmp/coercion-bridge.wasm before final assertions, so file presence is NOT passing evidence.

Reduced .tmp/probe-number-catch.mjs passes direct, numeric, envelope, callEnvelope and dynamic conversion controls (17490 terminal0, outputs1 each). Larger .tmp/probe-number-bridge.mjs reproduces exception with exact bridge source (71293). Scratch-only changing try body to local assignment then return outside did NOT fix62075; disabling KeepValue identity-search loop did NOT fix84700. Thus do NOT blame lookup or return-argument hoisting as established causes. Need inspect generated exception paths or reduce bridge surface further. No tests suppressed, production identity table unchanged, original thrown-value preservation remains required. All meaningful sessions terminal; preserve idle malformed22852. No commit/push/PR; full integration goal active.


### Numeric coercion timing root cause and compiler candidate

WAT669251 proves local value is f64 and call to coercing helper578 occurs BEFORE try_table. UsageInference incorrectly treated numeric-only uses as proof that moving ToNumber to initialization is observable-equivalent. Original thrown marker object confirmed by outer catch54292 (marker73, kind5). Root cause is not exception identity-table search. New ordinary regression issue-4376-numeric-coercion-timing.test.ts fails baseline69620 with escaping Wasm exception, passes candidate: catch boundary73, repeated valueOf effects32 (sum3/count2), skipped branch19.

Candidate src/checker/usage-inference.ts restricts USE-site route: every initializer/plain assignment must have checker-proven NumberLike/StringLike/BooleanLike/null/undefined type (unions all safe; assertions peeled). Unknown/objects/Symbol/BigInt decline this route. DEFINITION-site numeric oracle remains intact. Source comments corrected. Older issue-4121-unboxing-admission representation assertion expected f64 for unresolved s.next(); changed to externref with explanation since sources are not proven primitive. Existing runtime20008 A/B checks retained. No test suppression.

Compiler78255:32pass/1fail of33 before updating unsafe old shape assertion. Final21956:37pass/1fail of38 across4suites; remaining numeric-return-carriers flag-control failure reproduced exactly on clean5086736 baseline40165 (4pass/1fail of5). Thus remaining failure is baseline, not newly introduced. No broad conformance claim. Compiler diff-check passes; full gates/format still required before commit.

Runtime bridge test99382 and cleaned final31719 terminal0: five numeric strings, number-hint Symbol.toPrimitive42.9, and original thrown token handle identity all pass alongside existing buffer/identity tests. Final fixture .tmp/coercion-bridge-verified.wasm written ONLY after every assertion. No debugging logs remain in tracked test. Compiler-free Rust check61778 passed before compiler fix (runtime Rust unchanged). Native IntegerValue nonnumeric tests and full artifact rebuild are NOT yet done; current shipped core lacks new __v8x_value_to_number export. Next attach fresh compact fixture for native coercion/exception tests, add assignment-source regression controls and primitive proof retention, run gates/regressions, signed checkpoints/pins, rebuild/optimize/precompile production artifacts and replay unchanged Deno tests. Both worktrees have uncommitted changes; no push/PR. All meaningful processes terminal. Preserve malformed idle22852 and all scratch files/artifacts.


Native conversion candidate27858 passed1/1; combined12265 passed3/3,46filtered,5.14s. Cases cover12numeric boundaries,4simple primitives,Symbol/BigInt TypeErrors,6native strings,realm Symbol.toPrimitive, and exact thrown-object identity through native TryCatch. Fixture .tmp/coercion-bridge-verified.wasm compiled with candidate compiler, not production artifact. Compiler regression extended to plain assignment source;8254 passes33/33 across3suites. Prettier applied only3touched compiler/test files. Function/coercion/oracle gates pass; initial tsc command omitted Node types and failed640diagnostics, corrected standalone command tsc --noEmit --types node exits0 (3d8906). Exact synced-main0f5 LOC+function gates54204 terminal0. Ready for signed compiler checkpoint; runtime still uncommitted, production artifact/pins unchanged. No broad full-Deno conformance claim.


### Signed numeric-conversion checkpoints and production rebuild

Compiler bda15bdf70baefc3d7620f32a03dc3660c2fd005 signed; hooks and signature verified, tracked tree clean before this note. Runtime 0eaa1d8cb4aaeeb3ce159951e1bc1e652f36aecf signed; all5 compiler pin locations updated, syntax checks/diff-check pass, tracked tree clean except retained .tmp. Runtime README states attached-realm requirement and that full artifacts need rebuild. No push or PR; hashes remain local.

Clean detached inputs /private/tmp/deno-number-coercion-build.7sSHn7/{js2,v8x}; exact compilerbda15/runtime0eaa. js2/node_modules symlink established after worktree14395 terminal0. Deno clean input reused /private/tmp/deno-error-prototype-build.4UZS08/deno at1d4e6c1. Runtime-profile raw build77882 LIVE, log /private/tmp/deno-number-coercion-build.7sSHn7/build.log. Latest log shows normal native host-binding warnings, no terminal failure. Outputs core.wasm/provider.wasm/provenance.json. Do not rerun while handle live. Native example rebuild22687 also LIVE, compiler-free feature set, unchanged libs/core diff empty. Target /private/tmp/v8x-deno-followup-20260908/target. Wait these handles, then explicit bundled Binaryen125 --no-inline BEFORE -O3 --pass-arg=no-inline@__new_* --all-features --disable-custom-descriptors -g (do NOT invoke optimizer from unresolved runtime cwd and silently fall back). Validate fresh optimized provider canaries and exact globals, precompile with Wasmtime47.0.3, rebuild matching op2 graphs, replay unchanged hello_world/disable_ops/op2 and the two Deno unit tests. Previous interpreter-owner artifacts predate new conversion export and cannot certify current production integration.

Native example rebuild22687 TERMINAL exit0,53.98s. Raw artifact build77882 remains LIVE (verified0040e4). No replay against the new artifacts yet.


### Numeric production artifacts: raw build and core precompile complete

Raw build77882 TERMINAL exit0. Root /private/tmp/deno-number-coercion-build.7sSHn7: core7819498bytes SHA256f6e20993481bddb8f5a1fdf0bfb5f08438b24b7aeb0861fc8e057d4a29c410c1; provider25465792bytes SHA2567a1391606c0b454d5ea3baa9fb2c1d8bfcc6980d99bb2b844bc226cac1e48df1. Independent raw validator23990 passes5provider canaries,6exactSymbolglobals,deferredphase/probe0,and3numericstringconversions. Validator .tmp/validate-number-artifacts.mjs defaults optimized inputs, --raw selects raw.

Explicit Binaryen125 core optimization71799 TERMINAL exit0: core-O3.wasm5569305bytes SHA25638e387a1d911b259ac3ce32002a801bda04e992a8e88e0443b24a779261af121. Native core precompile35234 TERMINAL exit0,1/1,28.16s using js2wasm_spike-13320b163e76abe2, output core-O3.cwasm. Provider optimization34655 remains LIVE (last verified04eec5), output provider-O3.wasm. Do not restart/reuse old provider as full current evidence. Once complete run validator without --raw then precompile provider.

Deno unit binary rebuild46591 TERMINAL exit0,1m04s, /private/tmp/v8x-deno-followup-20260908/target/release/deps/deno_core-d58bdcae170364b9. Exact op2 graph build10847 TERMINAL exit0, newly output under root/op2-graphs; raw optimized hashes identical previous2763e681 and6276d038. Generic precompile26334d/3cbe93 passes1/1each,.19s. Bindinga7d99b completed: extensioncwasm76e1ac84324cf79d1aa81361472ce274bce0acd6e33898033d29bd178835f6c7,applicationc041c401ed911bcf081c631e9cb3824a21d34c6150d2b2e4e2acbb5070d913d4. Helper .tmp/build-op2-shared-graphs.mjs now points numeric root. No native replay newcore+newprovider pair yet.

Read unchanged runtime::tests::misc::test_v8_platform: constructs default platform, creates runtime, executes empty script. Add it to script-return and disabled-op replay. test_is_proxy is upstream-ignored (Fast API without snapshot), do not count as passing or silently enable. Async waker test can spin waiting on async op; defer until event-loop readiness is established, no unapproved process killing. Only meaningful live process is provider optimizer34655; preserve malformed idle22852 and all artifacts. Integration goal active, no push/PR.


### Fresh optimized pair replay completed; next async parsing gap

Provider optimizer34655 terminal0. Optimized provider15825798bytes SHA256bd19b42b7a66d36ea29647190e1a01aa47039b0fc81188da507946138011fb6f. Optimized validator539b7e passes5canaries,6exactglobals,deferredstate,and3numericconversions. Provider precompile75127 terminal0,1/1,114.09s. Both core/provider-O3.cwasm now exist at numeric root and were used together in all following current runs.

Unchanged hello_world75381 exit0 with exact sum6 and expected caught serde TypeError output; op297799 exit0 with4normalcallbacks includingop_use_state, no stdout. disable_ops10439 exit134, correct op-disabled JsError at unchanged example28:6, no Symbol diagnostic. Control50506 same newlybuilt binary with previous core/provider alsoexit134, identical semanticerror; Deno releaseprofile explicitly panic=abort (Cargo.toml485), so this is not an artifact regression or successful exit. Three unchanged selected unit tests pass: script-return80613 1/1,10.22s; disabled-op62319 1/1,10.97s; platform26599 1/1,10.15s. Each428filtered. No full429-case or general-Deno claim. Compiler-free features and pristine libs/core verifiedab97e0.

Expanded unchanged async test runtime::tests::misc::test_set_macrotask_callback_set_next_tick_callback3950 terminal101,0/1,12.07s. Fails execute_script before eventloop at misc.rs783 with SyntaxError: Binding rvalue (1:NaN). Same binary with previous core-cli-O3 and previous provider79587 reproduces exactly,0/1,10.80s. Existing gap, not new numeric-coercion regression. Source includes destructuring const op_async_sleep, async IIFE, queueNextTick object, immediate ref/unref methods, await, and template errors. Next reduce source through actual interpreter/provider path and compare parser behavior; do not edit Deno test. Error is rendered native Error though original trace says SyntaxError, another fidelity gap to track. Full integration goal remains active. All meaningful processes terminal; preserve malformed idle22852. No push/PR. Numeric artifacts are authoritative completed build; retain earlier control artifacts too.


### Async-script parser reduction: shorthand AST copy

Provider probe .tmp/probe-async-parser.mjs uses actual current optimized provider and a small separately compiled consumer. Initial matrix349165 (before extra rendering): arithmetic, renamed property {a:b}, array pattern, async function, async arrow and method return success envelopes. Shorthand {a}, default shorthand {a=2}, var shorthand, parameter shorthand, nested shorthand and async-await return failure envelopes. Error fields cannot be read directly because provider result values use a wrapper; attempted consumer intrinsic unwrap did not expose fields. Attempted provider exception renderer throws itself on that wrapper (46435), so current probe needs that diagnostic attempt removed before reusing; do not call these rendering failures parser failures. Native Deno still provides exact Binding rvalue (1:NaN) signature.

Pinned Acorn8.16.0 native Node oracle15f1f8 parses five sampled failing/successful syntax cases correctly. Actual extracted source /private/tmp/deno-number-coercion-build.7sSHn7/js2/tests/dogfood/.acorn/package/dist/acorn.mjs. parsePropertyValue3435ff uses copyNode(prop.key) ONLY for shorthand/default shorthand; renamed binding bypasses it. copyNode3911ff constructs new Node then for(var prop in node) newNode[prop]=node[prop]. checkLValSimple default raises Binding rvalue using expr.start. No Acorn/Deno source modifications.

Reduced compiler probe .tmp/probe-copy-node.mjs now matches constructor/prototype ownership: Node constructor initializes type/start/end plus optionalfields; Parser.prototype.copyNode clones via for-in; input typeIdentifier,namea,start6,end7. Exact candidatebda15 compiler emits valid module but returnsNaN instead of1167. Additional field controls57858 terminal0 (diagnostic harness, NOT pass): typeOk0,nameOk1,startNaN,endNaN. Thus expando name survives but initialized fields do not retain values through this copy. Earlier object-literal receiver version threw TypeError at copy method; do NOT attribute that separate receiver shape to Acorn. Current prototype reduction is the useful case. Next turn add ordinary compiler regression, compare direct/computed reads on original and copied nodes, inspect dynamic reads/setters of constructor-declared fields, then fix and replay real provider shorthand. Async-await failure may be separate; do not conflate without evidence. Runtime tracked clean at0eaa; compiler only issue dirty atbda15. No live meaningful computation, preserve malformed idle22852. No push/PR; integration remains active.


### Allocated subtype filtering drops Acorn base fields

Ordinary regression tests/issue-4376-node-property-copy.test.ts reproduced 3/8 passing on bda15: static original fields and copied expando name worked, while original computed type/start and copied type/start/end failed. Generated WAT showed __fnctor_Node__lay allocations inheriting base fields, but allocatedStructTypeIndices admitted only exact struct.new types. The finalized dynamic getter therefore omitted the unallocated base's inherited field arms. Extend the allocation set with transitive supertypes, retaining exclusion of unrelated unallocated shapes. No parser or Deno source changes.

Candidate regression passes8/8. Combined traversal, node-copy, computed-write, layout-emission and key-coercion suites66034 pass29/29 across5files. Added traversal control checks transitive ancestry and excluded unrelated type; updated existing synthetic test module to supply its types table. TypeScript7 with --types node and exact-main LOC/function gates69391 pass. Actual provider and native async test have NOT yet been rebuilt/replayed for this fix. All runtime artifacts remain previous bda15/0eaa pair; full integration remains incomplete.


Signed checkpoint 7a43c03297b7ab81a11437d1858fe9eda479e544 verified signature1 and clean tracked tree. Required coercion/oracle gates passed; dead-export command returned0 but strict closure remains OPEN/FAIL on existing unknown dynamic-import targets, preservation-only6/6; no retirement certification. Real provider build89086 terminal0 using current compiler and export Symbol state: .tmp/provider-inherited-fields.wasm25466445bytes, all5canaries pass. Direct provider replay2460 terminal1: arithmetic, shorthand const{a}, renamed and default shorthand succeed; parameter shorthand and async-await still return failure envelopes. 4/6 success envelopes, NOT async completion. Thus Acorn copy bug fixed for simple shorthand; residual forms need further diagnosis. This raw diagnostic provider has not yet been wasm-opt/precompiled, and native Deno async case not replayed. Existing full pinned artifact set remains bda15/0eaa. No push/PR. Goal active.


### Interpreter capability gaps after the Acorn field fix

Correct diagnostic decoding requires activating runtimeEvalCallableBoundaryEnabled: a provider-named declaration plus __runtime_eval_unwrap_result allows the consumer to unwrap the envelope, then the owning provider renders the error. Probe now reports exact UnsupportedNodeError for non-identifier parameter (ObjectPattern) and await outside dynamic import. These are emitter limitations, not parser errors. General async requires a resumable DispatchState/await opcode, Promise settlement and exception routing, async function marking/call behavior, and realm scheduling; FLAG_ASYNC is currently reserved and emitAwait only forwards ImportExpression.

Implement expression-free ObjectPattern parameters by reserving all positional input registers first, binding pattern names afterwards, and destructuring after function-environment creation but before hoisted function initialization. Preserve explicit refusal for defaults/computed parameter keys (distinct parameter environment/TDZ needed), array patterns (iterator semantics), and rest. Add RequireObjectCoercible to the shared ObjectPattern emitter, including empty patterns. New12-case native-oracle suite initially12/12fails, then12/12passes; exception names compared inside source to avoid cross-VM instanceof Error misclassification in runEval. Broad tests/interp run266/266 assertions across8files passes, but includes reporting-only corpus mismatches, not a conformance claim. TypeScript7 withNode types, exact-main LOC/function, coercion/oracle gates pass; dead-export command0 retains existing OPEN strict closure, no retirement certification.

Separate raw provider .tmp/provider-object-parameters.wasm25520361bytes built with current uncommitted emitter patch and passes5canaries. Build session89331 needs terminal confirmation. Prior inherited-fields wasm-opt session56638 remains live and must be retained, not restarted/killed. Full native Deno async replay still pending; no claim that general await works.
...
### Requested follow-up: startup profiling, native optimization, shared libraries

User requested phase profiling and optimized Wasmtime precompilation after the full-core measurement, then added shared-code library packaging. Preserve bda15/0eaa raw Wasm and previous .cwasm as controls. Runtime candidate adds opt-in inclusive phase timing and V8X_JS2WASM_CRANELIFT_OPT=none|speed|speed_and_size, keeping none default. Initial profile13.58s total: coreload269ms, providerload1031ms (nested within store/instances1083ms), moduleinit14ms, corescripts616ms total, usage1049ms. Roughly10s remains outside those timers; extend native script/function/module/dispose scopes before attributing it. Native speed core precompile succeeded29.84s wall, peakRSS5124571136bytes, artifact about86MiB. Provider speed compilation session67360 is live; do not restart or kill it. Current sources are uncommitted in /private/tmp/v8x-deno-followup-20260908; profiling artifacts /private/tmp/deno-profile.RCcI44.

Existing SharedDenoRuntime uses process-wide OnceLock, caches core Modules, and retains one provider Module. Both measured artifacts use deserialize_file, so generated executable code already has a file-backed loading path; mutable Store/Instance state remains per context. Shared-library work must distinguish a native runtime dylib from common generated .cwasm artifacts and measure private/shared memory, not merely move bytes between files. Native library deployment is not implemented yet. Full integration remains incomplete.

Shared-runtime follow-up: opt-in tools/deno/shared-runtime Rust dylib packaging now links the unchanged Deno hello_world in isolated /private/tmp/deno-shared-runtime-20260909. Requires CARGO_PROFILE_RELEASE_PANIC=unwind and matching Rust1.95.0 libstd loader path. otool proves libv8.dylib and libstd dependencies; replay97455 exits0, exact stdout cmp passes, stderr0bytes (1/1). Wrapper retains extra API methods, so102 additional packaging-only weak abort stubs were required; existing306 diagnostic exports explicitly retained/exported onmacOS. No new API implementation. Stripped copies: executable1683096, dylib6354296, libstd1205440bytes, total9242832 versus oldstatic2396592. No private-memory saving claim. Development absolute installname still needs relocation/signing for distribution.

Native speed artifact builds both completed: core89961816bytes, provider311005016bytes, total400966832 (382.4MiB), versus570264232 baseline (543.8MiB). Optimized exact native replay passes. One optimized observation11.59s/351207424peakRSS, not repeated medians. Native5s sample shows3627/3801main-thread samples under Object::Set during initialize_deno_core_ops_bindings; a large branch repeatedly transfers strings via one Wasm call per UTF16 unit. This sampling window is not total-run percentage. Shared library does not fix that bottleneck. Profiling and packaging source remain local pending review/commit; full Deno incomplete.


### Requested remeasurement after shared-library packaging

Next performance-gap work: post-bulk profile41951 still samples ObjectSet and packet creation with substantial GC/type dispatch beneath it. Replace adapter's linear __v8xKeepValue identity scan with compiler-native Map index, preserving negativezero separately because Map uses SameValueZero. Deleted transient packets must be removed from both roots and index. Start with native identity/Unicode/symbol/GC tests and then rebuild unchanged Deno core for alternating control/candidate measurement. Preserve bulk checkpoint12cba0b and comparison-bulk bundle as control. No Porffor timing claim while embedding dependency unavailable.

Index growth test exposed compiler-native Map hashing bug: __hash_anyref uses backing array length and starts at0 rather than NativeString logical length/offset. Adapter's empty constructed string got a different handle from literal empty string. Native string-view regression baseline6/7passes (sliced-key fails); fix reads flat fields0(length),1(offset), hashes data[offset+i]. Regression7/7passes and actual indexed adapter growth/packet-retirement fixture now passes; native fixture10/10identity/descriptors/symbol/etc tests pass. This is a correctness prerequisite for the hash-index optimization, not a speed claim. Full core rebuild pending.

Porffor follow-up requested: upstream littledivy/v8x PR76 "feat: porffor backend", head1a7dce790d75414fa72a784c5b84a251ffeb94c6 fetched into /private/tmp/v8x-porffor-benchmark-20260909. PR explicitly calls itself scaffold (75 implemented,745 stubbed), requires unlanded Porffor --lib support, and permits one live isolate per process. Source Script/Module/Function creation stubs mean unchanged Deno benchmark is not supported; do not publish fast failure or stub-only zero-test build as throughput. Investigating linked smoke-test reproduction and exact dependency before deciding what comparison is possible.

Porffor reproduction blocked on unavailable dependency: public littledivy/porffor only main61adb24cb90a0248f45cd9445d4c7118ba950cf9 lacks runtime/index.js and porf_embed ABI; exact generator command fails missing-module. Public branches/refs, PR comments and code search checked without finding implementation. Linked cargo attempt72557 failed earlier on vendor patch/setup and restricted ICU fetch;0smoke tests executed, no engine measurement. Report tools/deno/results/2026-09-09-porffor-reproduction.md distinguishes those setup problems from missingcompilerdependency and Deno API incompleteness. Need author's matching --lib compiler fork/commit; do not compare reported500KB object with completeDeno footprint.

Follow-up implementation: unchanged-Deno bulk UTF-16 transfer through temporary GC byte packets, and ordered property packets only for newly allocated unpublished host graph nodes. Existing/seeded objects keep immediate operations. Old artifacts retain scalar fallback. Candidate in runtime worktree; small compiled bridge fixture passes JavaScript assertions, native bulk roundtrip/property test running52028. Full core artifact rebuild and matched performance measurement pending. Root-table linear search and retained intermediate string prefixes are another confirmed source-level cost removed by bulk construction; do not equate that observation with measured speedup yet.

Completed bulk checkpoint77985de and measurement/packaging checkpoint12cba0b. Full rebuilt core plus byte-identical existing provider boots unchanged Deno with exact output. Native bulk roundtrip/order test1/1; graph/identity/descriptors/retry/buffer tests5/5; error/prototype2/2; non-string function names1/1; fresh linked-callback test1/1; legacy fallback1/1. Initial optional fixture failures were missing fixture/provider environment, resolved on explicit rerun. Full ten-run alternating scalar/bulk A/B44585 passes10/10: scalar median13104.327708ms, bulk11648.145416ms, elapsed11.1%lower (1.1xfaster rounded). RSSmedian352960512→354271232bytes; macOSphysical9978576→9945832bytes, effectively no memory improvement. No competing task builds/tests during A/B. Source/report tools/deno/bulk-transfer.md plus raw results/2026-09-09-bulk-ab.json. Deno source untouched; no claim that separate Deno calls are deferred or that V8/QuickJS gap is closed. Generic call caches and linear value-table lookup remain follow-ups. Stopped only redundant new provider optimizer46932 after confirming identical input SHA; did not terminate tests. Bulk artifacts /private/tmp/deno-profile.RCcI44/core-bulk{,-O3,-speed} plus bulk-provenance.json; build clean detached /private/tmp/v8x-bulk-artifact-20260909 at77985de, compilerbda15.
...
### AOT-first performance follow-up (2026-09-09)

Next goal turn (surpass QuickJS): previous turn classified progress (verified AOT implementation/measurements and both PR pushes). Native1ms sampler captured zero stacks on short AOT process; no hotspot attribution from empty sample. Source review finds native Map object keys all hash0, retaining linear bucket scans. Correctness-checked standalone WasmGC/Node probe on compiler824ea7b, no imports, 48/48checksums: object100/200/400/800keys at20lookup rounds median0.93/3.60/13.31/56.33ms; number keys0.17/0.18/0.22/0.25ms. Initial probe failed only because harness read result.wasm instead of result.binary; corrected actual compiler contract. Evidence .tmp/deno-map-scaling.mts/.log, not full Deno timing. Stable identity hashes need ABI support; raw moving-GC addresses are not acceptable persistent keys.

Also verified Cargo enables only Wasmtime gc-drc, so Auto falls back to reference counting; copying collector not available in current native bundle. Added opt-in js2wasm_gc_copying feature and V8X_JS2WASM_GC_COLLECTOR=drc|copying. Explicit DRC default preserves previous artifact ABI; copying rejected in frozen POC replay profile. Same choice required for precompile/replay. Native helper cargo build36616 live at .tmp/copying-helper-build.log. Deno diagnostic checkout Cargo feature updated but no Deno source changes. No copying performance/correctness claim yet. Next build helper, precompile existing core-aot-v2-O3.wasm using copying, build compiler-free shared runtime/example, validate GC/identity/buffer tests and exact output, then matched DRC/copying and QuickJS timing. Existing comparison-bulk and core-aot-v2-speed remain immutable controls.

User requests AOT first, existing QuickJS eval provider only as optional fallback, and no interpreter deployment when unused. Indexed adapter plus compiler string-view hash fix measured 12092.6ms→944.3ms in five quiet alternating pairs (10/10 exact output), 12.8x faster. Fresh three-engine run21/21 exact output: V8 9.0ms, QuickJS24.4ms, js2wasm905.4ms. Still37.1x slower thanQuickJS,100.7x slower thanV8. Deployment396.7MiB: core90.2/provider297.7/native8.8. Actual ELF sections315.9MiBtext,57.4GCmaps,13.3trap metadata,1.3other. Reports saved in runtime tools/deno/results/2026-09-09-indexed-* but not yet published. Compiler remote test/inventory work preserved in merge81cd54500091c9.

Runtime checkpoint3521525 adds explicit --profile=runtime --execution=aot, compiling the exact hash-pinned upstream usage source into core and rejecting unknown/repeated scripts. This is a bounded closed-world program, not a general classic-script/eval transform; function-wrapped declarations are not offered to later scripts. Removes runtime-eval linking, exports local Symbol state, rejects non-host imports, emits no provider file, uses separate schema2 provenance. Four generator tests pass, initial three failures were incorrect test print-count7 vs actual6; source/output comparison already matched. Clean full artifact build42569 running in /private/tmp/v8x-aot-artifact-20260909 with pinned compiler72f281a. Native replay and performance not yet established. Sandbox writable-root symlink prevented normal patches; user authorized workaround, direct codex --codex-run-as-apply-patch under approved escalation works without changing workspace settings.

### Preserved inventory handoff

Test packaging follow-up: new scope regression now executes Wasm in an explicit --experimental-wasm-exnref child process (same pattern as existing Deno tests), so default pnpm vitest invocation passes7/7 without localconfig. Production compiler and measured artifact remain exactb8b0bcaf; follow-upchanges test/handoffonly.

2026-09-10 module-scope compiler optimization measured: compilerb8b0bcaf2dc95810931fef63499a8d828c117ed8 committed, cleanpin/private/tmp/js2-module-eval-pinned-20260909. Runtimebuilderpin f6960db; artifactcleancheckout same. Optimizer24090terminal0; fixture1926pass; native9/9tests19628pass; optimizedcore2/2pass; precompile81478pass1/1; nativeunchangedhello_world exactoutputpasses. Same native5400404 onbothA/Bsides:77.7->65.9ms(15.2%lower),10/10correct. Threeengine21/21:V88.3/QJS23.1/js2wasm66.3ms,still2.9xbehindQuickJS. Payload49404984bytes47.1MiB,core40108424bytes38.3MiB,peakRSS44.4MiB,physical5.9MiB. NewcoreSHA2567948b4e70c5cb054b05b371a8dbd9820b3f78152ecfff1d795da1fc4fd65142c. Rawreport tools/deno/results/2026-09-10-module-eval-*; controlcore-bulk-strings-copying-speed andcandidatecore-module-eval-copying-speed withcomparison-module-evalbundle. No native/Deno sourcechanges, nointerpreter. ConfiguredTS7passed. Correctedcandidateunit19/22 vsbaseline12/15 exactsame3failures; own7/7passes. Normaltools nowwork; Git metadata/signingsocket stillrequiresapprovedescalation. No livebuild/testprocesses. Goalactive. Next shared-realm canonicalvalue handling triggered evenbyrefusal-onlyprovider andobjectMapcollisions; profilebeforeattribution.

Module-eval scope optimization in progress: normal sandbox tools work after writable-root update; do not use escalations (approval reviewer reported usage limit). Exact bridge probe plain~0.2ms/1000number roundtrips, refusal~2.2ms, refusal+unusedindirecteval~9.1ms. Candidate narrows hypothetical eval rebinding to private ES-module functions whose owning source has a direct-eval site; script/unknownowner/directeval remainconservative, ordinary static reassignment scanunchanged. Candidate indirectprobe~2.2ms andrawmodule2976597->1746851bytes; notDeno benchmark yet. Probe logs .tmp/bridge-call-indirect-{control,candidate}.log. Earlier WAT applyCalls regexcounts0 are NOT a call census because printer uses numericindices; don'treuseasstructuralevidence. Seven newtests pass; corrected Vitest workerexnref config .tmp/deno-eval-vitest.config.ts required becausebase execArgvoverridesparent. Candidate19/22 vsbaseline12/15, same3existingfailures (defaultimportreassignmentmoduleinit,2AnnexBcases), new7/7passincluding liveactualreassignment+alias. Initialmissingexceptionflag failures aren'tcompilerregressions. Sourcechanges src/ir/runtime-eval-boundary-plan.ts,src/codegen/index.ts,newtests/issue-4376-module-eval-binding-scope.test.ts. ConfiguredTS7typecheckpending; accidentalgenerictsc invokedwrongconfigmissingNodeglobals. ProductionDenocontrolstillruntime5400404/compiler72; nextcommitcleanpin, rebuildwasm-opt/nativeprecompile/fullDenovalidation+timing beforeclaimingimprovement. Allprobe/tests terminal.

Bulkstring completion: optimizer29515terminal0, fullcore2/2tests pass afterrerun, precompile93186terminal0(1/1). Same newnative5400404 onbothA/Bsides, old/newcore:82.0ms->75.5ms(7.9%lower),10/10correct. Three-engine21/21:V88.1,QJS22.4,js2wasm75.8ms,still3.4xbehindQuickJS. Payload59399176bytes=56.6MiB,core50102616bytes47.8MiB,RSS52.2MiB,physical5.9MiB. Reports/rawJSON/profile in runtime tools/deno/results/2026-09-09-bulk-strings*. Candidatecore-bulk-strings-copying-speed.cwasm SHA256cdefe232abd6f48b98890f3f5afc72ed41a3ddfd21cd933cc29be9dfda3f42fb. Profile confirms scalarunit/length exports no longer called; bulkreaderbypasses scalaraccountingso don'tcallnewcounttotalboundarycount. NativeDeno+source5400404verified; nointerpreter. Allprocesses terminal. Next investigate compiler property/identity dispatch and large lazy-global-initialization prologues; neither entiretyofgap nor prologueCPUcostattributed. Goalonactive,previousgoalturnsprogress. Compilerproductionstill72pin,nochanges; handoffdirtyincludespriornegativecacheexperiment.

Bulk UTF16 goal turn: runtime5400404 implements read-only __v8x_value_string_storage export and validated flat/slice/hashed/rope reading through Wasmtime rooted GC APIs, with old-export fallback. Fixture61584 terminal0, nativebuild82041 terminal0, native9/9tests1907pass. DRCnewfixture1/1 and copyinglegacyfallback1/1 session32837pass, including new slice/rope/deepconcat/lonesurrogate/invalidtype tests and repeatedGC. NativeDeno build18284terminal0. Clean artifact checkout moved to5400404; pinnedcompiler72 and unchangedDeno1d4e. Full rawbuild+Binaryen125O3 session29515 stillLIVE, rawcore exists and optimizer inprogress. Two dependent checks were mistakenly started before output existed and failedENOENT (notcodefailures): coretests andprecompile. Wait29515terminal before rerunning; do not restartliveoptimizer. Planned outputcore-bulk-strings-copying-speed.cwasm. No bulkstring performance claim yet. Best controlcomparison-string-cache/core-transient-copying-speed; compare same newnativeexe old/newcore to isolate bulkstrings. No interpreter shipped. Prior typedcache negativeexperiment checkpoint5d60432published; compilerissuehandoff fromthatturn remainslocaluncommitted.

Next goal turn made diagnostic progress, not a speedup. Runtime ba1cd2c experiments with store-local validated TypedFunc cache and opt-in RealmCallProfile. Candidate9/9native tests plus focused wrong-signature/failed-insertion/GC check pass. Same artifact five-pair A/B: control2f90064 80.7ms, candidateba1cd2c81.1ms,10/10correct; three-engine21/21mediansV88.0/QJS22.2/candidate80.3ms. No measured improvement, so typed cache removed forward; diagnostic-only final source focusedtest1/1pass. Full raw evidence tools/deno/results/2026-09-09-typed-calls-* plusrealm-profile.txt. Exact-output diagnostic counts1,814realm calls; define_data317/8.0ms,get188/7.3ms,utf16_unit434/6.1ms inclusive,notexclusive or medians. Best production baseline remains2f90064(79.8ms),nottypedcandidate. Next implement bulk UTF16 read to eliminate per-code-unit calls, preserving lone surrogates, slice offsets, rope strings and forcedGC. Existing compiler native string layout registerNativeStringTypes: flat fieldslen/off/i16array,rope len/left/right,hashed flat subtypeextra field. Prefer explicit export/storage ABI validation, no rawGCaddresses. All test/build sessions terminal. Candidate/control bundles preserved comparison-typed-calls/comparison-string-cache, samecore-transient-copying-speed.cwasm. BuildtreeDeno binary stilltypedcandidate until nextrebuild; do not accidentally benchmark it as final diagnostic-onlycode. Compiler production code unchanged; goal stillactive3.6xbehindQuickJS.

2026-09-09 resumed through approved command-path workaround without changing workspace settings. Runtime b8addd8 transient packets completed full AOT/O3 build and native replay; 21/21 three-engine rows and 10/10 paired rows pass. Same native executable, old/new core paired medians 138.1/120.1 ms. Runtime 2f90064 bounded realm-local short-string cache then measured with identical transient core and preserved old/new executables: 120.5/79.4 ms, 10/10 exact outputs. Fresh three-engine comparison passes 21/21: V8 8.1 ms, QuickJS 22.2 ms, js2wasm 79.8 ms. Still 3.6x slower than QuickJS, goal remains active. Deployment 59,245,592 bytes (56.5 MiB), predominantly 49,971,320-byte precompiled core; no interpreter/provider deployed. Final focused cache/forced-GC/eviction test passes copying/new artifact and DRC/legacy artifact. Nine native tests passed before final long-string lookup guard. Reports and complete raw evidence in runtime tools/deno/results/2026-09-09-{transient,string-cache}-*. Compiler production pin remains 72f281a; Deno source unchanged at 1d4e6c1. Controls preserved in comparison-transient and comparison-string-cache under /private/tmp/deno-profile.RCcI44, both using core-transient-copying-speed.cwasm for cache isolation. No live builds/tests remain. Remaining general object Map hash collisions are not fixed by these adapter optimizations. Next investigate stable object-identity hashing and remaining startup work; no warm-throughput or tenant-density claim.

Next goal turn classified prior as progress: copyingcollector code+tests+31benchrows published in runtimec8a150c. Runtimeb8addd8 now separates private unpublished transient packets from canonical objectindex. Dedicated packet-create appends rooted value and tracks numeric IDs; retirement removes canonical index only for legacy buffers. Persistent buffer identity unchanged; native code falls back when old artifact lacks newexport. Expanded fixture86451 passes512unique transientpacket retirement/doubleconsume refusals, invalidlengths and persistentview.buffer identity. Native9/9tests55814 pass with copying, including forcedGChelper. NativeDeno build42535 terminal0. Full core build+O3 session79919 live; raw8.3MiB produced, samecompiler72 and Deno pin, clean detachedruntimeb8addd8. Nextprecompilecopying, exactnative+legacyfallback, matched A/B oldcopying vsnewtransient; no performanceclaim yet. Immutable priorcontrol comparison-copying/core-aot-copying-speed. Old compiler Map objecthashall0 persists; do not represent packetslice as generalidentityhashfix.

Copying collector follow-up: helper36616, precompile68825 and compiler-free Deno build49172 all terminal0. Same optimized core-aot-v2-O3 input precompiled with copying yields49348336bytes vsDRC102154008. Exact native replay passes without provider. Runtime6e088a7 implements explicit opt-in collector and forced-GC tests. Nine existing native identity/prototype/descriptor/retry/error/symbol/coercion/buffer tests9/9pass; strengthened realm test1/1copying and1/1DRC passes two explicit Store.gc(None) calls. Unknown collector and collector/artifact mismatch both reject with empty stdout. Same new native executable on both A/B sides: five alternating pairs10/10 exactoutput, DRC252.7ms vs copying133.9ms (1.9x faster). Threeengine21/21: V88.2ms,QuickJS22.1ms,copying135.0ms,still6.1x slower thanQuickJS/16.4x thanV8. Deployment58620560bytes=55.9MiB,core47.1MiB;RSS51.9MiB,physical5.8MiB. No build/test/hook overlap timing. Reports/raw files tools/deno/results/2026-09-09-copying-* and map-scaling.json. Runtime docs aot-first.md explains feature and matching precompile/replay selector; DRC remains default and frozenPOCrejectscopying. No goalcompletionclaim. Next investigate stable objectidentity hashing or eliminate transientpacket Map scans; movingGC rulesoutrawaddresspersistentkeys. All sessions terminal; controls preserved in comparison-bulk/core-aot-v2-speed. Candidate bundle comparison-copying pluscore-aot-copying-speed. Deno diagnosticCargo addsfeatureonly,noDeno sourceedits.

AOT follow-up completed: initial strict census rejected two remaining runtime-eval imports. Runtime90d0fbe embeds the existing explicit-refusal source locally (no parser/interpreter), and exports local Symbol state. Full clean core build64226 passes;16native host imports only, no memory/provider imports. Binaryen125 O3 and Wasmtime47.0.3 speed precompile13806 pass. Native unchanged Deno example exits0/exact103bytes with both provider environment variables absent. Four generator tests and two compiled-Wasm tests pass; unknown script refuses with zero host-op calls. Runtimef5a28bb checkpoints report/tests/guarded dispatch. Five alternating pairs10/10: indexed863.4ms vs AOT253.3ms,3.4x faster. Three-engine21/21: V88.3ms/QJS22.6ms/AOT255.2ms. AOT still11.3x slower thanQJS,30.8x slower thanV8. Deployment111401176bytes=106.2MiB (core102154008bytes=97.4MiB plusnative8.8); interpreter297.7MiB absent,73.2% total reduction fromindexed396.7. AOTRSS92.7MiB,physical6.0MiB, nottenantcost. All rawdata checkedin tools/deno/results/2026-09-09-aot-*. No task build/test/hook overlapped timing. Separate diagnosticusage39.8ms,coreload7.6,instances1.5,core scripts31.1combined; inclusive/nested notmedians. Provider-free scheme is explicitly bounded hash-pinned singleprogram, rejects unknown/repeat source, notgeneralclassic-scriptsemanticssupport. Dynamicmode still oldinterpreter; QuickJSnativefallbackintegration remainsfollow-up. Artifacts /private/tmp/deno-profile.RCcI44/core-aot-v2{,-O3,-speed}, provenanceaot-v2-provenance.json. NeitherfullDenonorQuickJSparity claimed.
