...
func-budget-allow:
  ...
  # (#4157 B) the same +3 lines, seen per-function. `compileExpressionInner` is
...
## 2026-08-13 (31) — the `compiled` bucket, first two slices: defect B is a call-count win, defect A is a CODE-SIZE win, and B's real finding is why the naive CSE is wrong
