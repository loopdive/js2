...
| lane                  |        median | standard deviation |
| --------------------- | ------------: | -----------------: |
| standalone Wasm       | 0.00065250 us |      0.00000222 us |
| equivalent Node batch | 0.25859905 us |      0.00274133 us |
| Wasm speedup          |   **396.32x** |                    |

The run used 1,083,846 operations per round. The 20,340-byte module has zero
