...
describe("#4104 IR async plan runtime consumer", () => {
  ...
  it("attaches the standalone native runtime without changing the target-neutral semantic plan", () => {
    ...
    // (#3526 F1-S1, F1-S2) The frozen policy always publishes an explicit
    // resolved decision for every value-boundary family; an async-only
    // preparation resolves them all disabled.
