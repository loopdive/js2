...
const ESLINT_LINTER_ENTRY = resolve(__dirname, "../../node_modules/eslint/lib/linter/linter.js");
...
`,
  ...
  it("Tier 1c — `eslint/lib/linter/linter.js` direct compile succeeds", () => {
    const r = compileProject(ESLINT_LINTER_ENTRY, { allowJs: true });
    expect(r.success).toBe(true);
    if (r.success) {
