...
import { test262TestPath } from "./test262-fixture-path.ts";
...
describe("Issue 559: coerce arithmetic result to externref before call", () => {
  ...
  it("S11.6.2_A3_T2.2: str-num subtraction", async () => {
    await testFile(test262TestPath("language/expressions/subtraction/S11.6.2_A3_T2.2.js"));
  });

  it("S11.6.2_A3_T2.5: bool-str subtraction", async () => {
    await testFile(test262TestPath("language/expressions/subtraction/S11.6.2_A3_T2.5.js"));
  });

  // Multiplication tests
  it("S11.5.1_A3_T2.2: str-num multiplication", async () => {
    await testFile(test262TestPath("language/expressions/multiplication/S11.5.1_A3_T2.2.js"));
  });

  it("S11.5.1_A3_T2.5: bool-str multiplication", async () => {
    await testFile(test262TestPath("language/expressions/multiplication/S11.5.1_A3_T2.5.js"));
  });

  // Division tests
  it("S11.5.2_A3_T2.2: str-num division", async () => {
    await testFile(test262TestPath("language/expressions/division/S11.5.2_A3_T2.2.js"));
  });

  it("S11.5.2_A3_T2.5: bool-str division", async () => {
    await testFile(test262TestPath("language/expressions/division/S11.5.2_A3_T2.5.js"));
  });

  // Modulus tests
  it("S11.5.3_A3_T2.2: str-num modulus", async () => {
    await testFile(test262TestPath("language/expressions/modulus/S11.5.3_A3_T2.2.js"));
  });

  it("S11.5.3_A3_T2.5: bool-str modulus", async () => {
    await testFile(test262TestPath("language/expressions/modulus/S11.5.3_A3_T2.5.js"));
  });

  // Addition tests
  it("S11.6.1_A3.2_T2.3: addition test", async () => {
    const testPath = test262TestPath("language/expressions/addition/S11.6.1_A3.2_T2.3.js");
    if (!fs.existsSync(testPath)) return;
