...
describe("issue-854 test262 cases", () => {
  it("Array.prototype.entries for-of", async () => {
    const r = await runTest262(test262TestPath("language/statements/for-of/Array.prototype.entries.js"));
    console.log("Array.prototype.entries:", r);
  });

  it("Array.prototype.keys for-of", async () => {
    const r = await runTest262(test262TestPath("language/statements/for-of/Array.prototype.keys.js"));
    console.log("Array.prototype.keys:", r);
    expect(r).toBe("PASS");
  });

  it("ArrayIteratorPrototype next/Int16Array", async () => {
    const r = await runTest262(test262TestPath("built-ins/ArrayIteratorPrototype/next/Int16Array.js"));
    console.log("ArrayIteratorPrototype Int16Array:", r);
  });

  it("ArrayIteratorPrototype next/args-mapped-iteration", async () => {
    const r = await runTest262(test262TestPath("built-ins/ArrayIteratorPrototype/next/args-mapped-iteration.js"));
