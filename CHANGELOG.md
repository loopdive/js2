...
This file records historical milestone tags and the Git history on `main`.
...
Latest complete archived full-suite entry: `20260331-215747` from `benchmarks/results/runs/index.json`

- Pass rate: `15,155 / 48,174` = `31.5%`
- Previous full-suite entry: `15,246 / 48,174` = `31.7%`
- Note: `benchmarks/results/test262-report.json` currently points to a missing target, so the pass rate above is sourced from the run index rather than the symlink.
