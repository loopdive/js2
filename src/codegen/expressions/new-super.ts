...
function emitDynamicNewFallback(
  ...
  const typedConstructDriver =
    !useRuntimeArgv &&
    (lateAssignedResultWasmType?.kind === "ref" || lateAssignedResultWasmType?.kind === "ref_null")
      ? (linkLateAssignedConstructResultAncestor(
          ctx,
          lateAssignedResultType!,
          lateAssignedResultWasmType.typeIdx,
        ),
        reserveTypedNativeConstructDriver(ctx, args.length, lateAssignedResultWasmType.typeIdx))
      : undefined;
