  ...
  for (const instr of body) {
    switch (instr.op) {
      ...
      case "try":
        ...
        break;
      default: {
        // Catch-all for any future instruction shapes not enumerated above.
        // The historical Instr-bypass casts were removed in #1526; this
        // default branch remains as a defensive safety net.
