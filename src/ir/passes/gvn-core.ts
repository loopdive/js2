...
/** Fresh transaction-owned diagnostic data; never runtime or serialized authority. */
export function createGvnCounters(): GvnCounters {
  return Object.seal(Object.assign(Object.create(null) as GvnCounters, { functions: 0, merged: 0, poisoned: 0 }));
}
 ...
 */
export function gvnCore(fn: IrFunction, opts: GvnOptions, counters: GvnCounters): IrFunction {
