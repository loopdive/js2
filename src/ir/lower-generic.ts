...
import { IR_STRING_ITERATOR_CHAR_AT_FN } from "./string-runtime.js";
import type { BlockType, Instr, LocalDef, ValType } from "./types.js";
...
export function projectIrFunctionSignatureWithConverter<S, Slot>(
  func: IrFunction,
  resolver: IrLowerResolver,
  emitter: BackendEmitter<S>,
