...
import {
  ...
  type ResolvedKind,
} from "./selection-return-types.js";
export { irClosureSignatureFromFunctionTypeNode } from "./selection-return-types.js";
...
function resolveReturnType(
  ...
  if (mapped?.kind === "generator-object") {
    return jsHostExternsEnabled(currentSelectionOptions) ? "object" : null;
  }
