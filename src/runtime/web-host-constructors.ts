...
export function getWebHostConstructors(): Record<string, Function> {
  return Object.fromEntries(
    "MessageChannel MessagePort ReadableStream WritableStream TransformStream TextEncoder TextDecoder Headers Request Response FormData Blob File AbortController AbortSignal IntersectionObserver queueMicrotask"
      .split(" ")
