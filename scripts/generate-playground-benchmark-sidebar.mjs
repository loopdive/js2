...
const HELPERS_PATH = resolve(WEBSITE_ROOT, "playground", "examples", "benchmarks", "helpers.ts");
...
const PUBLIC_PATH = resolve(WEBSITE_ROOT, "public", "benchmarks", "results", "playground-benchmark-sidebar.json");
...
async function measureBenchmark(entryPath, exportName) {
  const absEntryPath = resolve(WEBSITE_ROOT, "playground", entryPath);
