#!/usr/bin/env node
//
// Render website/docs/adr/*.md → dist/pages/docs/adr/*.html.
//
...
//
// Inputs:  website/docs/adr/*.md     (and website/docs/adr/README.md for the index)
...
const ADR_SOURCE_DIR = join(ROOT, "website", "docs", "adr");
...
export function buildAdrPages() {
  if (!existsSync(ADR_SOURCE_DIR)) {
    console.log(`[build-adr-html] no website/docs/adr directory found at ${ADR_SOURCE_DIR} — skipping`);
    return;
  }
