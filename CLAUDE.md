...
applies them. Required checks today (`docs/ci-policy.md` §7): `cheap gate
(main-ancestor + lint)`, `merge shard reports`, `check for test262
...
`linear-tests` (ci.yml), `cla-check`. The dev-self-merge skill is a UX
...
**test262 conformance**: 29,843 / 43,095 (69.2 %)
