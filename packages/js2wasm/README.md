...
The compatibility target is ECMAScript itself, with TypeScript supported as a source-language layer rather than as a custom language contract. Test262 is the current public measurement baseline.
