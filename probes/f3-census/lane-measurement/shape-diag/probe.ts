...
import { analyzeFiles } from "/home/user/js2/src/checker/index.js";
import { buildIrUnitInventory } from "/home/user/js2/src/ir/identity.js";
import { buildIrPlanningIdentityContext } from "/home/user/js2/src/ir/planning-identity.js";
import { buildIrUnitTypeMap } from "/home/user/js2/src/ir/propagate.js";
import { planIrCompilationByIdentity, projectIrSelectionToLegacy } from "/home/user/js2/src/ir/select-identity.js";
import type { IrFallback, IrFallbackReason, IrSelection } from "/home/user/js2/src/ir/select.js";
import type { IrObservedOutcome } from "/home/user/js2/src/ir/outcomes.js";
import { makeIrHostDateSnapshotResolver } from "/home/user/js2/src/ir/host-date.js";
import { makeIrHostGlobalResolver, makeIrHostVoidCallbackResolver } from "/home/user/js2/src/ir/host-extern.js";
import { makeIrPromiseDelayResolver } from "/home/user/js2/src/ir/promise-delay.js";
import {
...
} from "/home/user/js2/src/ir/module-bindings.js";
import {
  makeIrIdentityImportedFunctionResolver,
  projectIrIdentityImportedFunctionResolverToLegacy,
} from "/home/user/js2/src/ir/imported-functions.js";
import { compile, compileFiles } from "/home/user/js2/src/index.js";
...
const REPO_ROOT = "/home/user/js2";
const BASELINE_PATH = join(REPO_ROOT, "scripts/ir-fallback-baseline.json");
const CORPUS_ROOTS = ["/home/user/js2/.tmp/r6-f3-census/lane-measurement/corpus"];
