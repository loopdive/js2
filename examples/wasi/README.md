...
targets; see #679 and #682) applied to filesystem I/O. The
...
- **Hardcoded preopen dirfd = 3.** Most WASI runtimes assign fd=3 to the
  ...
  walk via `fd_prestat_get` / `fd_prestat_dir_name` is tracked in #1041.
...
See #1035 for the design notes and full follow-up list.
